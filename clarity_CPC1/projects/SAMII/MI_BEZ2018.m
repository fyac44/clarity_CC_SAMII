...
if useGPU
    ...
    [spt_per.right,~] = BEZ2018_GPU(per_audio(:,2), fs_p, ...
    ...
    [spt_trans.right,~] = BEZ2018(trans_audio(:,2), fs_t, ag_fs, ...
    ...
    [spt_per.right,~] = BEZ2018(per_audio(:,2), fs_p, audiogram.cfs, ...
        audiogram.right, CFs, numsponts_healthy);
end
