                        ...
                        const int totalANFs)
{
    ...
    double sout10, sout11, sout12, sout20, sout21, sout22;
    ...
    for (k=0; k<ndownsampled; k++)
    {
        ...
        sout10  = __max( 0, powerLawIn + sigma*randNum - alpha1*I1);
        sout20  = __max( 0, powerLawIn - alpha2*I2);
        ...
        {
            n10 = 1.992127932802320*n11 + 1.0e-3*(sout20 - 0.994466986569624*sout21);
        ...
        {
            n10 = 1.992127932802320*n11 - 0.992140616993846*n12 + 1.0e-3*(sout20 - 0.994466986569624*sout21 + 0.000000000002347*sout22);
        ...
        {
            m10 = 0.491115852967412*m11 + 0.2*(sout10 - 0.173492003319319*sout11);
        ...
        {
            m10 = 0.491115852967412*m11 - 0.055050209956838*m12 + 0.2*(sout10 - 0.173492003319319*sout11 + 0.000000172983796*sout12);
