...
%[neurogram_Sout,t_Sout,t_mr,CFs] = generate_neurogram_BEZ2018_CUDA(stim,Fs_stim,species,ag_fs,ag_dbloss);
%[neurogram_ft,neurogram_mr,t_ft,t_mr,CFs] = Copy_of_generate_neurogram_BEZ2018_CUDA(stim,Fs_stim,species,ag_fs,ag_dbloss);
